...
public class ServerTestSuite {
    ...
    void serverTest2() {
        ...
        assertDoesNotThrow(() -> new ServerImpl("Server name", ThreadLocalRandom.current().nextInt(0, 65535 + 1)));
    ...
    void serverTest4() {
        ...
        server = new ServerImpl("Server name", 1234);
        assertDoesNotThrow(() -> {
            server.addBoards(new Board("mia scheda 1", "seriale 123"), new Board("mia scheda 2", "seriale 456"),
    ...
    void serverTest5() {
        ...
        assertDoesNotThrow(() -> {
            ...
            assertEquals(testBoard, server.listBoards().iterator().next());
